...
const Sparks = (props) => {
  ...
  const particleCount = props.particleCount || 10;
  ...
  return (
    <div className={Util("relative h-full w-full", props.containerClassName)}>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ref={containerRef}
      ...
      <div className={Util("relative z-10", props.className)}>
        {props.children}
      </div>
    </div>
  );
